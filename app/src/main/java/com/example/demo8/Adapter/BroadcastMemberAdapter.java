...
public class BroadcastMemberAdapter extends RecyclerView.Adapter <BroadcastMemberAdapter.ViewHolder>{
    ArrayList<Users> arrayList;


    public BroadcastMemberAdapter(@NonNull MemberItemInterface memberItemInterface) {
    ...
    @NonNull
    @Override
    public BroadcastMemberAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        MemberItemLayoutBinding binding = MemberItemLayoutBinding.inflate(
                LayoutInflater.from(parent.getContext()),parent,false);

        return new BroadcastMemberAdapter.ViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull BroadcastMemberAdapter.ViewHolder holder, int position) {
